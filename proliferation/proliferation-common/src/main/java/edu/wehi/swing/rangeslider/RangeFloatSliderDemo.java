 ...
 */
public class RangeFloatSliderDemo extends JPanel {
    ...
    private RangeFloatSlider rangeSlider = new RangeFloatSlider(-20, 100, 10000);

    public RangeFloatSliderDemo() {
        ...
        rangeSlider.addChangeListener(new ChangeListener() {
            public void stateChanged(ChangeEvent e) {
            	RangeFloatSlider slider = (RangeFloatSlider) e.getSource();
                rangeSliderValue1.setText(String.valueOf(slider.getValueAsDouble()));
                rangeSliderValue2.setText(String.valueOf(slider.getUpperValueAsDouble()));
            }
        });
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                new RangeFloatSliderDemo().display();
            }
        });
    }
}