...
import console.streams.ConsoleInputStream;
import console.streams.ConsoleOutputStream;
...
public class JConsole extends JTextArea implements KeyListener
{
	 ...
	 * 
	 */
	public JConsole(InteractiveInterpreter engine)
	{
		setEngine(engine);
	}
	...
	public JConsole()
	{
		this(new InteractiveInterpreter());
	}
